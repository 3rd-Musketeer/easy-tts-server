...
class TextSegmenter:
    ...
    def segment_sentences(self, text: str, language: str, min_tokens: int = None) -> List[str]:
        """
        ...
        if language not in self.supported_languages:
            raise ValueError(f"Unsupported language: {language}. Supported languages: {self.supported_languages}")
        ...
        try:
            ...
            for sentence in raw_sentences:
                ...
                sentence_tokens = len([token for token in sentence_doc if not token.is_space])
    ...
    def segment_text(self, text: str, language: str, min_tokens: int = None) -> List[str]:
        """
...
def segment_text(text: str, language: str, min_tokens: int = None) -> List[str]:
    """
